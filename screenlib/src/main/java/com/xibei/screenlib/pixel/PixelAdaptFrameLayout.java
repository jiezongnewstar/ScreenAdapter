 ...
 * Deeclaration: 根据设计稿比例进行帧布局适配
 */
public class PixelAdaptFrameLayout extends FrameLayout {

    private boolean mesured = false;

    public PixelAdaptFrameLayout(Context context) {
        this(context,null);
    }

    public PixelAdaptFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PixelAdaptFrameLayout(Context context,AttributeSet attrs, int defStyleAttr) {
